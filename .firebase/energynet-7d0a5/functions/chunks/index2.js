...
const config = {
  ...
  loaders: [
    ...
    },
    {
      ...
      loader: async () => (await import("./get-what-you-need.js")).default
    },
    {
      locale: "bg",
      key: "get-what-you-need",
      routes: ["/solutions/get-what-you-need"],
      loader: async () => (await import("./get-what-you-need2.js")).default
    }
  ]
};
const { t: t2, loading, locales, locale, translations, loadTranslations, addTranslations, setLocale, setRoute } = new D(config);
